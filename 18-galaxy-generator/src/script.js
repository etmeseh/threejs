...
import { depth, SceneNode, vertexColor } from 'three/examples/jsm/nodes/Nodes.js'
...
gui .add(parameters, 'radius').min(0.01).max(30).step(0.01).onFinishChange(generateGalaxy)
